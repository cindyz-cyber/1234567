...
async function generateFullReport() {
  const birthDate = new Date('1994-07-17T00:30:00+08:00');

  console.log('═══════════════════════════════════════════════════════════════');
  console.log('            玛雅历能量人格完整报告');
  console.log('═══════════════════════════════════════════════════════════════');
  console.log(`出生日期: 1994年7月16日后子时（7月17日00:30）`);
  console.log('═══════════════════════════════════════════════════════════════\n');
  ...
  console.log(`   ${'█'.repeat(Math.floor(kinDef.totem.pineal_gland / 5))}${'░'.repeat(20 - Math.floor(kinDef.totem.pineal_gland / 5))}`);
  console.log(`💬 喉轮（表达沟通）: ${kinDef.totem.throat_chakra}%`);
  console.log(`   ${'█'.repeat(Math.floor(kinDef.totem.throat_chakra / 5))}${'░'.repeat(20 - Math.floor(kinDef.totem.throat_chakra / 5))}`);
  console.log(`❤️  心轮（情感连接）: ${kinDef.totem.heart_chakra}%`);
  console.log(`   ${'█'.repeat(Math.floor(kinDef.totem.heart_chakra / 5))}${'░'.repeat(20 - Math.floor(kinDef.totem.heart_chakra / 5))}`);
  console.log('');
