import{r,j as t,P as V,p as X,G as R}from"./index-vuyfw79y.js";import{C as ee}from"./chevron-left-8l5rxcLa.js";const ie=async m=>{const s=Date.now(),p=await m,n=Date.now()-s;return n<3e3&&await new Promise(d=>setTimeout(d,3e3-n)),p},O=[{label:"喜悦",hue:45,angle:0},{label:"平和",hue:120,angle:45},{label:"焦虑",hue:210,angle:90},{label:"迷茫",hue:270,angle:135},{label:"愤怒",hue:0,angle:180},{label:"悲伤",hue:200,angle:225},{label:"丰盛",hue:50,angle:270},{label:"其他",hue:180,angle:315}],te=[{label:"紧绷",angle:0},{label:"松弛",angle:60},{label:"温热",angle:120},{label:"空洞",angle:180},{label:"沉重",angle:240},{label:"其他",angle:300}],U=(m,f,s,p)=>{const n=m*Math.PI/180,d=p*.123,g=f+Math.sin(d*100)*s;return{x:50+g*Math.cos(n),y:50+g*Math.sin(n)}};function se({onNext:m,onBack:f}){const[s,p]=r.useState([]),[n,d]=r.useState([]),[g,A]=r.useState(""),[v,ae]=r.useState("emotion"),[C,B]=r.useState(0),[k,E]=r.useState(!1),[u,S]=r.useState(""),[x,F]=r.useState(""),[Z,j]=r.useState(!1),[H,N]=r.useState(!1),[z,$]=r.useState([]),[T,y]=r.useState(new Set),[P,re]=r.useState(!1);r.useState(.25),r.useEffect(()=>(console.log("🎭 EmotionScan mounted"),()=>console.log("🎭 EmotionScan unmounted")),[]);const W=r.useMemo(()=>O.map((e,o)=>({...e,position:U(e.angle,28,4,o)})),[]),_=r.useMemo(()=>te.map((e,o)=>({...e,position:U(e.angle,22,3,o)})),[]);s.length>0||n.length>0,r.useEffect(()=>{if(z.length===0)return;const e=setInterval(()=>{$(o=>o.filter(a=>a.life>0).map(a=>({...a,x:a.x+a.vx,y:a.y+a.vy,vy:a.vy+.2,vx:a.vx*.98,life:a.life-.016})))},16);return()=>clearInterval(e)},[z.length]);const I=(e,o)=>{const a=[];for(let c=0;c<15;c++){const h=Math.PI*2*c/15+(Math.random()-.5)*.4,b=3+Math.random()*2;a.push({id:`${Date.now()}-${c}`,x:e,y:o,vx:Math.cos(h)*b,vy:Math.sin(h)*b-1.5,life:1})}$(c=>[...c,...a])},Y=()=>{"vibrate"in navigator&&navigator.vibrate(10)},K=(e,o,a)=>{const i=a.currentTarget.getBoundingClientRect(),c=i.left+i.width/2,h=i.top+i.height/2;if(e==="其他"){j(!0);return}s.includes(e)?(p(l=>l.filter(w=>w!==e)),y(l=>{const w=new Set(l);return w.delete(e),w}),B(0)):(Y(),I(c,h),y(l=>new Set([...l,e])),setTimeout(()=>{p(l=>[...l,e]),B(o)},150))},q=(e,o)=>{const a=o.currentTarget.getBoundingClientRect(),i=a.left+a.width/2,c=a.top+a.height/2;if(e==="其他"){N(!0);return}n.includes(e)?(d(b=>b.filter(l=>l!==e)),y(b=>{const l=new Set(b);return l.delete(e),l})):(Y(),I(i,c),y(b=>new Set([...b,e])),setTimeout(()=>{d(b=>[...b,e])},150))},M=()=>{u.trim()&&(p(e=>[...e,u.trim()]),S(""),j(!1))},D=()=>{x.trim()&&(d(e=>[...e,x.trim()]),F(""),N(!1))},J=()=>{s.length>0&&n.length>0&&(E(!0),setTimeout(()=>{m(s,n)},800))},L=()=>{g.trim()&&(E(!0),setTimeout(()=>{m(s,n)},1200))},Q=n.length>0?"身体的反馈是？":"此刻，你的情绪是？",G=()=>{};return console.log("🎨 EmotionScan rendering, step:",v),t.jsxs(t.Fragment,{children:[t.jsx(V,{videoSrc:"https://sipwtljnvzicgexlngyc.supabase.co/storage/v1/object/public/videos/backgrounds/mf2l1xwzmq-1773037528059.mp4",posterImg:X,overlayGradient:"linear-gradient(to bottom, rgba(0, 0, 0, 0.2) 0%, rgba(2, 13, 10, 0.25) 50%, rgba(0, 0, 0, 0.22) 100%)"}),t.jsxs("div",{className:"min-h-screen flex flex-col px-6 py-12 breathing-fade relative",style:{position:"relative",zIndex:1},children:[z.map(e=>t.jsx("div",{className:"particle",style:{left:e.x,top:e.y,opacity:e.life,transform:`translate(-50%, -50%) scale(${e.life})`}},e.id)),f&&t.jsx("button",{onClick:f,className:"absolute top-8 left-6 z-50 flex items-center justify-center w-10 h-10 rounded-full transition-all hover:scale-110",style:{backgroundColor:"rgba(235, 200, 98, 0.1)",border:"1px solid rgba(235, 200, 98, 0.3)",backdropFilter:"blur(10px)"},children:t.jsx(ee,{size:24,color:"#EBC862"})}),v==="emotion"?t.jsxs("div",{className:"flex-1 flex flex-col justify-center items-center max-w-6xl mx-auto w-full relative",style:{paddingTop:"60px",paddingBottom:"60px"},children:[t.jsx("div",{className:"mb-16 text-center transition-all duration-500",children:t.jsx("p",{className:"text-sm title-text",style:{color:"#FFFFFF",fontWeight:500,letterSpacing:"0.25em",textShadow:"0 2px 4px rgba(0, 0, 0, 0.95), 0 4px 12px rgba(0, 0, 0, 0.8)",position:"relative",zIndex:100},children:Q})}),t.jsx("div",{className:"mandala-container relative w-full",style:{height:"400px",marginBottom:"80px"},children:W.map((e,o)=>t.jsxs("button",{onClick:a=>K(e.label,e.hue,a),onTouchStart:G,className:`glass-bubble emotion-bubble mandala-bubble ${e.label==="其他"?"other-bubble":""} ${T.has(e.label)?"popping":""} ${s.includes(e.label)?"selected":""}`,style:{position:"absolute",left:`${e.position.x}%`,top:`${e.position.y}%`,transform:"translate(-50%, -50%)",animationDelay:`${o*.1}s`,backgroundColor:"transparent"},children:[[...Array(6)].map((a,i)=>t.jsx("div",{className:`golden-particle-inner ${e.label==="其他"?"silver-particle":""}`,style:{animationDelay:`${i*1.3}s`,animationDuration:`${7+i%3}s`}},i)),t.jsx("div",{className:"bubble-content",children:e.label})]},e.label))}),Z&&t.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center",style:{backgroundColor:"rgba(0, 0, 0, 0.7)",backdropFilter:"blur(10px)"},children:t.jsxs("div",{className:"relative w-full max-w-md mx-6 p-8 rounded-3xl",style:{background:"rgba(255, 255, 255, 0.1)",backdropFilter:"blur(20px)",border:"1px solid rgba(247, 231, 206, 0.3)",boxShadow:"0 0 30px rgba(247, 231, 206, 0.5), 0 0 60px rgba(247, 231, 206, 0.2)"},children:[t.jsx("p",{className:"text-center mb-6",style:{color:"#FFF9E5",fontWeight:400,letterSpacing:"0.25em",fontSize:"16px",textShadow:"0 0 10px rgba(0, 0, 0, 0.8), 0 2px 8px rgba(255, 255, 255, 0.6)"},children:"请输入你的情绪"}),t.jsx("input",{type:"text",value:u,onChange:e=>S(e.target.value),onKeyPress:e=>e.key==="Enter"&&M(),placeholder:"例如: 期待、感恩...",autoFocus:!0,className:"w-full mb-6 px-6 py-4 rounded-2xl text-center",style:{background:"rgba(255, 255, 255, 0.15)",border:"1px solid rgba(247, 231, 206, 0.4)",outline:"none",color:"#EBC862",fontSize:"18px",letterSpacing:"0.15em",fontFamily:"Georgia, Times New Roman, serif"}}),t.jsxs("div",{className:"flex gap-4",children:[t.jsx("button",{onClick:()=>{j(!1),S("")},className:"flex-1 py-3 rounded-xl transition-all",style:{background:"rgba(255, 255, 255, 0.1)",border:"1px solid rgba(247, 231, 206, 0.3)",color:"#FFFFFF",letterSpacing:"0.2em"},children:"取消"}),t.jsx("button",{onClick:M,disabled:!u.trim(),className:"flex-1 py-3 rounded-xl transition-all",style:{background:u.trim()?"rgba(247, 231, 206, 0.2)":"rgba(255, 255, 255, 0.05)",border:"1px solid rgba(247, 231, 206, 0.5)",color:u.trim()?"#EBC862":"rgba(255, 255, 255, 0.3)",letterSpacing:"0.2em",cursor:u.trim()?"pointer":"not-allowed"},children:"确定"})]})]})}),t.jsx("div",{className:"mandala-container relative w-full",style:{height:"350px",marginBottom:"50px"},children:_.map((e,o)=>t.jsxs("button",{onClick:a=>q(e.label,a),onTouchStart:G,className:`glass-bubble body-bubble mandala-bubble ${e.label==="其他"?"other-bubble":""} ${T.has(e.label)?"popping":""} ${n.includes(e.label)?"selected":""}`,style:{position:"absolute",left:`${e.position.x}%`,top:`${e.position.y}%`,transform:"translate(-50%, -50%)",animationDelay:`${(o+O.length)*.1}s`},children:[[...Array(5)].map((a,i)=>t.jsx("div",{className:`golden-particle-inner ${e.label==="其他"?"silver-particle":""}`,style:{animationDelay:`${i*1.5}s`,animationDuration:`${6.5+i%3}s`}},i)),t.jsx("div",{className:"bubble-content",children:e.label})]},e.label))}),H&&t.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center",style:{backgroundColor:"rgba(0, 0, 0, 0.7)",backdropFilter:"blur(10px)"},children:t.jsxs("div",{className:"relative w-full max-w-md mx-6 p-8 rounded-3xl",style:{background:"rgba(255, 255, 255, 0.1)",backdropFilter:"blur(20px)",border:"1px solid rgba(247, 231, 206, 0.3)",boxShadow:"0 0 30px rgba(247, 231, 206, 0.5), 0 0 60px rgba(247, 231, 206, 0.2)"},children:[t.jsx("p",{className:"text-center mb-6",style:{color:"#FFF9E5",fontWeight:400,letterSpacing:"0.25em",fontSize:"16px",textShadow:"0 0 10px rgba(0, 0, 0, 0.8), 0 2px 8px rgba(255, 255, 255, 0.6)"},children:"请输入你的身体感受"}),t.jsx("input",{type:"text",value:x,onChange:e=>F(e.target.value),onKeyPress:e=>e.key==="Enter"&&D(),placeholder:"例如: 麻木、刺痛...",autoFocus:!0,className:"w-full mb-6 px-6 py-4 rounded-2xl text-center",style:{background:"rgba(255, 255, 255, 0.15)",border:"1px solid rgba(247, 231, 206, 0.4)",outline:"none",color:"#EBC862",fontSize:"18px",letterSpacing:"0.15em",fontFamily:"Georgia, Times New Roman, serif"}}),t.jsxs("div",{className:"flex gap-4",children:[t.jsx("button",{onClick:()=>{N(!1),F("")},className:"flex-1 py-3 rounded-xl transition-all",style:{background:"rgba(255, 255, 255, 0.1)",border:"1px solid rgba(247, 231, 206, 0.3)",color:"#FFFFFF",letterSpacing:"0.2em"},children:"取消"}),t.jsx("button",{onClick:D,disabled:!x.trim(),className:"flex-1 py-3 rounded-xl transition-all",style:{background:x.trim()?"rgba(247, 231, 206, 0.2)":"rgba(255, 255, 255, 0.05)",border:"1px solid rgba(247, 231, 206, 0.5)",color:x.trim()?"#EBC862":"rgba(255, 255, 255, 0.3)",letterSpacing:"0.2em",cursor:x.trim()?"pointer":"not-allowed"},children:"确定"})]})]})}),t.jsx("div",{className:`w-full max-w-md mx-auto continue-button-wrapper transition-all duration-700 ${s.length>0&&n.length>0?"opacity-100 translate-y-0":"opacity-0 translate-y-4 pointer-events-none"}`,children:t.jsx(R,{onClick:J,disabled:s.length===0||n.length===0||k,className:"w-full golden-breath",children:k?"正在继续...":"继续"})})]}):t.jsxs("div",{className:`flex-1 flex flex-col justify-center items-center max-w-2xl mx-auto w-full ${P?"transitioning":"active"}`,children:[t.jsxs("div",{className:"w-full mb-8 relative",children:[t.jsx("div",{className:`consciousness-line ${v==="writing"&&!P?"line-grow":""}`}),t.jsx("textarea",{value:g,onChange:e=>A(e.target.value),placeholder:"在此书写你的感受...",className:`conscious-writing ${k?"submitting":""}`,rows:1,autoFocus:!0}),t.jsx("div",{className:"text-reflection","aria-hidden":"true",children:g})]}),t.jsx("div",{className:"w-full",children:t.jsx(R,{onClick:L,disabled:!g.trim(),className:"w-full",children:"完成"})})]}),t.jsx("style",{children:`
        .particle {
          position: fixed;
          width: 3px;
          height: 3px;
      ...
      `})]})]})}export{se as default,ie as waitForGoldenTransitionMinimum};
